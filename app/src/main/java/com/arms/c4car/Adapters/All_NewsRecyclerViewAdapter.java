...
public class All_NewsRecyclerViewAdapter extends RecyclerView.Adapter<All_NewsRecyclerViewAdapter.ViewHolder> implements View.OnClickListener {
    ...
    public All_NewsRecyclerViewAdapter(Context context, List<DataModel> items) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.all_news_list_items, parent, false);
