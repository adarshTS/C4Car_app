...
import com.arms.c4car.Utils.ReaderViewPagerTransformer;
...
public class HomeFragment extends Fragment {
    ...
    public void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new NewCarFragment(), "NEW CARS");
        adapter.addFrag(new NewsFragment(), "LATEST NEWS");
      //  adapter.addFrag(new MarkedFragment(), "MARKED");
